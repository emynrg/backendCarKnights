...
export default multer({
  ...
  storage: diskStorage({
    ...
    destination: (req, file, callback) => {
      ...
      callback(null, join(__dirname, "../public/images/users")); // Indiquer l'emplacement de stockage
    },
  ...
  limits: 10 * 1024 * 1024,
}).single("imageUser"); // Le fichier est envoyé dans le body avec nom/clé 'image'